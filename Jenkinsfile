pipeline {
	...
	stage ('start ansible-play book') {
            steps {
	    	script {
                   sh 'ansible loadbalancer -m shell -a "ansible-playbook /home/user1/ansible/ansible-playbook.yml" -i /var/lib/jenkins/workspace/jenkins-github-webhook/ansible-inventory.ini'
